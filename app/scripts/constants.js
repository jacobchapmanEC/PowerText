...
// Define CURSOR_TRACKING_HTML separately
...
// Export DEBUG separately
export const DEBUG =
  !chrome || chrome.i18n.getMessage("@@extension_id") !== ATE_CONST.APP_ID_PRODUCTION;
